...
{
    internal class AES256 : ICryptoAlgorithm
    {
        public readonly int KeySize = 256;
        public readonly int BlockSize = 128;
        ...
        public string Encrypt(string val)
        {
            ...
            using (var cryptoStream = new CryptoStream(memStream, aes.CreateEncryptor(_byteSecretKey, _byteIV), CryptoStreamMode.Write))
            {
