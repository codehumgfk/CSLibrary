...
{
    public class Swap : AbstractProduct, IFICCProduct
    {
        public double SwapRate;
        public bool IsFixedSide;
        ...
        public virtual double GetPerRate(IInterpolator dfInterpolator)
        {
            var floatSidePV = GetFloatSidePV(dfInterpolator);
        ...
        protected virtual double GetFloatSidePV(IInterpolator dfInterpolator)
        {
            var asof = Schedules.AsOf;
